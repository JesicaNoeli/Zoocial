...
<body>
<br><br>
<table align="center"><tr><td colspan="2"><h4 class="text-success">Busca publicaciones de tu interes</h4></td></tr><tr>
        <td><form method="post" action="<?php echo $helper->url("post","verPosts"); ?>">
